...
volatile long facilatycode = 0;
volatile long reader1 = 0;
volatile int reader1Count = 0;
volatile long cardNumber = 0;
...
void loop() {
  //if(reader1Count == 8){ facilatycode = reader1;}
  if(reader1Count == 26){
   
    //  Serial.print(" Reader 1 ");Serial.println(reader1,HEX);
//  Serial.println("A");Serial.println(reader1 & 0xfffffff);
    Serial.print("    Card Data: ");Serial.println(reader1,BIN);
    facilatycode = reader1;
    facilatycode = facilatycode >> 17;// shift card data 17 places to leave the 9 places for facilaty code 
    facilatycode = facilatycode & 255;// then remove highest bit to leave facilaty data 
    
    Serial.print("Facilaty Code: ");Serial.println(facilatycode,DEC);  
    cardNumber = reader1 & 65535;cardNumber = cardNumber >> 1; // mask every thing to just leave card data then shift 1 bit to remove parity data
    Serial.print("  Card Number: "); Serial.println(cardNumber,DEC);
